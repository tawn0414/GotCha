...
public class search_fuel extends Fragment {
    ListView listView;
    public search_fuel() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_search_fuel, container, false);
        listView = v.findViewById(R.id.search_fuel);
        Context context = container.getContext();
        String fuel="fuel";
        final Map<String, String> map = new HashMap<String, String>();
        map.put("method", "fuelSearch");
        map.put("fuel", fuel);
